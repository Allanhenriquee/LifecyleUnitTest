...
public class CustomerSharedCollectionTwoTest : IClassFixture<CustomerFixture>
{
    private readonly CustomerFixture _fixture;
    private readonly ITestOutputHelper _testOutputHelper;

    public CustomerSharedCollectionTwoTest(CustomerFixture fixture, ITestOutputHelper testOutputHelper)
    {
        _fixture = fixture;
